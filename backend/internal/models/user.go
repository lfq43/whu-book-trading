...
type User struct {
	...
	Account   string    `gorm:"uniqueIndex;size:50;not null" json:"account"` // 账号名，唯一，最大50字符，不能为空
	Username  string    `gorm:"size:50;not null" json:"username"`            // 用户名，显示用，最大50字符，不能为空
